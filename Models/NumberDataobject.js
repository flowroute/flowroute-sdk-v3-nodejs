...
/**
 * Creates an instance of NumberDataobject
 */
class NumberDataobject extends BaseModel {
    /**
     * @constructor
    ...
    static mappingInfo() {
        return super.mappingInfo().concat([
            { name: 'attributes', realName: 'attributes', type: 'NumberAttributes' },
            { name: 'id', realName: 'id' },
...
module.exports = NumberDataobject;
